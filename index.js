...
client.on('message', msg => {
  ...
  if (msg.content === "?help") {
    const help = new Discord.MessageEmbed()
      ...
      .setURL('https://discord.gg/mCEwP64faj')
      .addFields(
        { name: '**❤️Love Commands**', value: '**?love** - To Find Your Love.\n**?rateme** - To Rate Yourself\n**?status** - To check your love\'s status\n**?cupid** - Check Bot\'s Informations\n**?hug @tag** - To Hug Someone'},
        { name: '\u200B', value: '**📣Annoy Commands**\n**?annoy @tag** - Mention Someone **25x** times' },
        { name: 'Github Link', value: 'https://github.com/Tom225-tech/Cupid-Bot-JS' }
      )
